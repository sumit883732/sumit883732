...
<td width="38%" valign="top" style="padding-right: 15px;">
...
## 🚀 Key Projects
- EV Motor Torque-Speed Analysis using MATLAB Simulink  
- DC Motor Control using Arduino + L298N + Ultrasonic Sensor  
- Three-Phase Inverter Design for EV Applications  
- Lithium-Ion Battery Thermal Management System (Air–PCM Cooling)  

---

## 📄 Publications
- Torque–Speed Behavior Analysis of Five Electric Motors (ICEES 2025)  
- Drive Cycle-Based EV Component Sizing (ICVTTS 2025)  
- Thermal Model of 18650 Cell for SoC Prediction (ICIICS 2026 - Submitted)  
...
## 📊 Certifications
- MATLAB, Simulink, Simscape Battery (MathWorks)  
- Machine Learning Onramp  
- Power Systems Simulation  
- Motor Control (FOC, PID)  
